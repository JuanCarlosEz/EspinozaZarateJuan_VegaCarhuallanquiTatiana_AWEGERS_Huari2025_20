        ...
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:space-x-6 sm:items-center">
                ...
                @auth
                    ...
                    @if(Auth::user()->role === 'administrador')
                        ...
                        <a href="{{ url('/reportes') }}" class="text-gray-700 hover:text-green-600 font-medium">Reportes</a>

                        {{-- ✅ NUEVO BOTÓN RUTAS --}}
                        <a href="{{ url('/rutas') }}" class="text-gray-700 hover:text-green-600 font-medium">Rutas</a>
                    @endif
            ...
            <div class="flex items-center sm:hidden">
                <button id="menu-toggle" class="text-gray-600 hover:text-gray-800 focus:outline-none">
                    <svg class="h6 w-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div id="mobile-menu" class="hidden sm:hidden px-4 pb-4 space-y-2">
        ...
        @auth
            ...
            @if(Auth::user()->role === 'administrador')
                ...
                <a href="{{ url('/reportes') }}" class="block text-gray-700 hover:text-green-600">Reportes</a>
                <a href="{{ url('/rutas') }}" class="block text-gray-700 hover:text-green-600">Rutas</a>
            @endif
